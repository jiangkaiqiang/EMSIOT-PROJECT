...
public interface BlackelectMapper {
    ...
    /*2018-12-17*/
    Integer findBlackelectsListCount(@Param("proPower") Integer proPower,@Param("cityPower") Integer cityPower,@Param("areaPower") Integer areaPower,@Param("dealStatus") Integer dealStatus);
