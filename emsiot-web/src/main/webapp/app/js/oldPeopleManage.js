coldWeb.controller('oldPeopleManage', function ($rootScope, $scope, $state, $cookies, $http, Upload, $location) {
    $scope.load = function(){
...
//    });
    ...
    //	}
    //	if(peopleIDs.length >0 ){
    //		window.location.href="/i/elect/exportElectByIDs?peopleIDs="+peopleIDs;
    //	}
    //	else{
    //		alert("请先选择要导出的车辆！");
    //	}
